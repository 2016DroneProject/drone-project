...
public class managertext3 : MonoBehaviour {
...

    {
        ...
        FileStream f = new FileStream(m_strPath + "Land.txt", FileMode.Append, FileAccess.Write);
...

    {
        ...
        TextAsset data = Resources.Load("Land", typeof(TextAsset)) as TextAsset;
