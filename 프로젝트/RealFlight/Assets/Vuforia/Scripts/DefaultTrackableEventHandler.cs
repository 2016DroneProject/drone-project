                                                ...
                                                ITrackableEventHandler
    {
        ...
        private void OnTrackingLost()
        {
            ...
            foreach (Renderer component in rendererComponents)
            {
                if (isRender)
                {
                    if (component.transform.parent.gameObject.tag == "HpUnit"
                        || component.transform.parent.gameObject.tag == "ArmorUnit"
                        || component.transform.parent.gameObject.tag == "AttkUnit"
                        || component.transform.gameObject.tag == "EnemyUnit")
                    {
                        component.enabled = true;
                    }
                    else
            ...
            foreach (Collider component in colliderComponents)
            {
                if (isRender)
                {
                    if (component.transform.parent.gameObject.tag == "HpUnit"
                        || component.transform.parent.gameObject.tag == "ArmorUnit"
                        || component.transform.parent.gameObject.tag == "AttkUnit"
                        || component.transform.parent.gameObject.tag == "EnemyUnit"
                        || component.transform.gameObject.tag == "BaseBuilding"
                        || component.transform.gameObject.tag == "EnemyBuilding")
                    {
                        component.enabled = true;
                    }
                    else
